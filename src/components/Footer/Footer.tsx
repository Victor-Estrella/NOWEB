...
export default function Footer() {
  return (
    <footer className="bg-[#181818] text-white py-10 lg:py-16 px-6 lg:px-26">
      <div className="flex flex-col mx-auto">
        ...
        <div className="flex justify-between items-start mb-10 lg:mb-12">
          <h1 className="text-3xl lg:text-5xl font-semibold leading-tight max-w-xl">
            We Develop And<br />Create Modern Future
          </h1>

          <div className="relative flex items-start gap-1 mt-2">
            <img src={OkHand} alt="Ok Hand" className="w-12 lg:w-auto" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-0">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <p className="leading-relaxed font-light text-xl">
                123 Company Name, Street Name,<br />City Name, Country Name – 12345
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2 bg-white rounded-full px-4 py-5 flex-1 min-w-0">
                <FontAwesomeIcon icon={faEnvelope} className="text-[#6C6C6C] text-[16px] shrink-0" />
                <input
                  type="email"
                  placeholder="Enter email address"
                  className="bg-transparent text-black text-sm outline-none w-full min-w-0 placeholder:text-[#6C6C6C]"
                />
              </div>
              <button className="bg-[#D3EDD8] hover:bg-[#8fc989] transition-colors duration-200 rounded-full p-3 flex items-center justify-center text-white cursor-pointer shrink-0">
                <Send color="#17412D" />
              </button>
            </div>
          </div>
