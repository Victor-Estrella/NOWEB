...
export default function CTA() {
    return (
        <section className="relative bg-[url(./assets/cta_img.jpg)] bg-cover bg-center bg-no-repeat w-full h-105 py-12 flex flex-col justify-center items-center gap-6">
